...
triggers:
  ...
  - "youtube summary"
  - "analyze video"
metadata: {"neuro":{"emoji":"📺","requires":{"bins":["yt-dlp"]}}}
---
...
```bash
python skills/youtube-watcher/scripts/get_transcript.py "https://www.youtube.com/watch?v=VIDEO_ID"
```
...
1. Get the transcript:
   ```bash
   python skills/youtube-watcher/scripts/get_transcript.py "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
   ```
