...
python skills/humanize-ai-text/scripts/compare.py text.txt -o clean.txt
```
...
```bash
python skills/humanize-ai-text/scripts/detect.py essay.txt
python skills/humanize-ai-text/scripts/detect.py essay.txt -j  # JSON output
python skills/humanize-ai-text/scripts/detect.py essay.txt -s  # score only
echo "text" | python skills/humanize-ai-text/scripts/detect.py
```
...
```bash
python skills/humanize-ai-text/scripts/transform.py essay.txt
python skills/humanize-ai-text/scripts/transform.py essay.txt -o output.txt
python skills/humanize-ai-text/scripts/transform.py essay.txt -a  # aggressive
python skills/humanize-ai-text/scripts/transform.py essay.txt -q  # quiet
```
...
```bash
python skills/humanize-ai-text/scripts/compare.py essay.txt
python skills/humanize-ai-text/scripts/compare.py essay.txt -a -o clean.txt
```
...
1. **Scan** for detection risk:
   ```bash
   python skills/humanize-ai-text/scripts/detect.py document.txt
   ```

2. **Transform** with comparison:
   ```bash
   python skills/humanize-ai-text/scripts/compare.py document.txt -o document_v2.txt
   ```

3. **Verify** improvement:
   ```bash
   python skills/humanize-ai-text/scripts/detect.py document_v2.txt -s
   ```
...
Edit `skills/humanize-ai-text/scripts/patterns.json` to add/modify:
